...
The combined derived work uses GPL-3.0-only and includes EnCAP's GPLv3 license text. No FFmpeg executable or large third-party media asset is redistributed here. Host packaging continues to own FFmpeg licensing notices and distribution details.
